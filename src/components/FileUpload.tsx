...
const Dropzone = ({
    ...
    onDrop(acceptedFiles, fileRejections, event) {
      if (props.onDrop) {
        ...
        if (acceptedFiles.length > 0) {
          // Replace previous files with the newly accepted file
  ...
  return (
    <div className='flex flex-row justify-center items-center w-screen'>
      <div className={cn("flex flex-col gap-2 w-1/2", containerClassName)}>
        <div
        ...
        <Button onClick={parseFile} disabled={filesUploaded.length == 0}>
          Analyze Data
          <span className='ml-2'>
